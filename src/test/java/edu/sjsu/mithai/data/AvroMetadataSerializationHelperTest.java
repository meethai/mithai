...
public class AvroMetadataSerializationHelperTest {
    ...
    public void deserialize() throws Exception {
        ...
        AvroGraphMetadata metadata = new
...
//        localGraph.add(p3);
        ...
        AvroMetadataSerializationHelper h = new AvroMetadataSerializationHelper();
        h.serialize(metadata);
        h.deserialize(h.serialize(metadata));
    }
